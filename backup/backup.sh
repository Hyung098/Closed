...
MYIP=$(curl -sS ipv4.icanhazip.com)
NameUser=$(curl -sS https://raw.githubusercontent.com/Hyung098/Zapanes/main/Bill | grep $MYIP | awk '{print $2}')
...
link="https://raw.githubusercontent.com/versi01/backup/main/$NameUser/$NameUser.zip"
sleep 1
