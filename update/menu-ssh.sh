...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/versi01/Project/main/ssh/proxy3.js"
cat <<EOF > /etc/systemd/system/sshws.service
[Unit]
Description=WSenabler
Documentation=https://Lawonvpn
...
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/versi01/Project/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
...
Login=lawon`</dev/urandom tr -dc X-Z0-9 | head -c4`
hari="1"
Pass=1
